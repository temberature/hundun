...
<#macro docHead title="" keywords="" description="" css=[] namespace="" vml=false xFrame="" canonical="" agent=[] robots=false touchIcon="" clean=false webviewTitle="" meta={} metaList=[] bodyStyle="" bodyClass="" viewportContent="" googleExperimentKey="" useWebCache = true showItunesApp=true>
    ...
    <#if metaList?size == 0>
        <#local metaList = [{"property":"og:type", "content":"money"}, {"property":"og:title", "content":"立马理财"}, {"property":"og:url", "content":"https://www.lmlc.com/wap"}, {"property":"og:image", "content":"https://www.lmlc.com" + "//localhost:8080/cdn/mobile/common/core/img/oglogo.dc2e89c228.png"}] />
    </#if>
    <@docHeadCore
    domain = sys_domain
    title = title
...
<#-- 测试后台数据代码 -->
    ...
    js = jsFileList + js
    delayJS = delayJS
    mockjaxLib = ["//localhost:8080/cdn/.remote/mockjax/jquery-mockjax/jquery.mockjax.8b1ece853e.js", "//localhost:8080/cdn/.remote/mockjax/mock/mock.15b1814c05.js"]
    mockjax = mockjax
    >
        <#nested><#t>
    </@docFootCore>
