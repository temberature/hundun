...
判断内嵌客户端类型
-->
    <#assign userAgent = RequestParameters["User-Agent"]!'' +" "+ RequestParameters["X-Requested-With"]!'' />
...
<#-- 通用的来源参数 -->
    ...
    <#assign RES_JS_BASE_LIST = ['//localhost:8080/cdn/mobile/common/base/base.ea34ea5b2d.js']/>
